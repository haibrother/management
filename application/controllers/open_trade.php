...
class Open_trade extends CI_Controller
{
	...
	public function trade_list(){
        ...
        //获取当前栏目的所有版本和默认版本
        $data['version'] = $this->trade_model->get_all_version(array('trade_type'=>'open','version_month'=>$trade_search_data['search_month']));
		...
		$data['delete_version_url'] = 'open_trade/delete/';
	...
	public function delete($search_month='',$search_version=''){
        ...
        $where = array('trade_type'=>'open','version_month'=>$search_month,'version'=>$search_version);
        $this->trade_model->delete_version($where);
        
        //跳转到列表页
        header("Location:/open_trade?clear=1");
	}
